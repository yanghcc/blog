...
### [最佳实践](https://github.com/Gillespie59/eslint-plugin-angular#best-practices)
...
### [使用angular内部的方法](https://github.com/Gillespie59/eslint-plugin-angular#angular-wrappers)
